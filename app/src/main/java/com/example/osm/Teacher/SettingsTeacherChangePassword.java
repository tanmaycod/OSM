...
public class SettingsTeacherChangePassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_teacher_change_password);
        ...
        loadingDialog = new LoadingDialog(SettingsTeacherChangePassword.this);
        ...
        phone = new UserCurrent(SettingsTeacherChangePassword.this).getUsername();
        activePassword = new UserCurrent(SettingsTeacherChangePassword.this).getPass();
                ...
                if (currentPassword.equals("") || password.equals("") || rePassword.equals("") || password.length() < 6) {
                    ...
                    if (rePassword.equals(password)) {
                        ...
                        if (currentPassword.equals(activePassword)) {
                            ...
                            reference.child("teacher").child(phone).updateChildren(profileMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(SettingsTeacherChangePassword.this, "Password changed succesfully.. Re-login..", Toast.LENGTH_LONG).show();
                                    new UserCurrent(SettingsTeacherChangePassword.this).removeUser();
                                    Intent intent = new Intent(SettingsTeacherChangePassword.this, LoginActivity.class);
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    loadingDialog.dismissDialog();
                                    Toast.makeText(SettingsTeacherChangePassword.this, "Error." + e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
    ...
    public void onBackPressed() {
        startActivity(new Intent(SettingsTeacherChangePassword.this, SettingsTeacher.class));
        finish();
    }
