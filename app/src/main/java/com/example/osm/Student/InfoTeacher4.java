...
public class InfoTeacher4 extends AppCompatActivity {
    TextView mNameProfile, mMobileProfile, mCityProfile, mQualification, mCollegeProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_teacher4);
        ...
        reference.child(mobile).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(InfoTeacher4.this, "Error.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(InfoTeacher4.this, "Error: " + databaseError.getMessage(),
    ...
    public void onBackPressed() {
        Intent intent2 = new Intent(InfoTeacher4.this, InfoTeacher.class);
