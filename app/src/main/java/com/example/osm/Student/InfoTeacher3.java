...
public class InfoTeacher3 extends AppCompatActivity {
    TextView mNameProfile, mEmailProfile, mCityProfile, mQualification, mCollegeProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_teacher3);
        ...
        reference.child(mobile).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(InfoTeacher3.this, "Error.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(InfoTeacher3.this, "Error: " + databaseError.getMessage(),
    ...
    public void onBackPressed() {
        Intent intent2 = new Intent(InfoTeacher3.this, InfoTeacher.class);
