...
public class StudentProfileEdit extends AppCompatActivity {
    EditText mFirstName, mLastName, mEmail, mCity;
    TextView mDob;
    String firstName, lastName, email, city, dob, mobileNo;
    Button mBtnSaveEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(StudentProfileEdit.this);
        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Student Profile Edit");
        ...
        mBtnSaveEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (firstName.equals("") || lastName.equals("") || city.equals("")) {
                    ...
                    Toast.makeText(StudentProfileEdit.this, "Please don't save blank details..", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (email.equals("-")) {
                        reference.child(mobileNo).updateChildren(profileMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                loadingDialog.dismissDialog();
                                Intent intent2 = new Intent(StudentProfileEdit.this, StudentProfile.class);
                            ...
                            public void onFailure(@NonNull Exception e) {
                                loadingDialog.dismissDialog();
                                Toast.makeText(StudentProfileEdit.this, "Error: " + e.getMessage(),
