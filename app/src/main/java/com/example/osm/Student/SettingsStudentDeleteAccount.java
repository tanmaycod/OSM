...
public class SettingsStudentDeleteAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_student_delete_account);
        ...
        loadingDialog = new LoadingDialog(SettingsStudentDeleteAccount.this);
        ...
        contact = new UserCurrent(SettingsStudentDeleteAccount.this).getUsername();
        activePassword = new UserCurrent(SettingsStudentDeleteAccount.this).getPass();

        reference = FirebaseDatabase.getInstance().getReference("credentials").child("student").child(contact);
                ...
                if (pass.equals("") || confirmPass.equals("")) {
                    ...
                    if (confirmPass.equals(pass)) {
                        ...
                        if (confirmPass.equals(activePassword)) {
                            loadingDialog.dismissDialog();
                            final AlertDialog.Builder builder = new AlertDialog.Builder(SettingsStudentDeleteAccount.this);
                                    ...
                                    reference.removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            referenceData.removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void aVoid) {
                                                    Toast.makeText(SettingsStudentDeleteAccount.this, "Account deleted succesfully..", Toast.LENGTH_LONG).show();
                                                    new UserCurrent(SettingsStudentDeleteAccount.this).removeUser();
                                                    Intent intent = new Intent(SettingsStudentDeleteAccount.this, LoginActivity.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(SettingsStudentDeleteAccount.this, SettingsStudent.class));
        finish();
    }
